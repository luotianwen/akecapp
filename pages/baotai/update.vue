	...
	<view class="content">
			...
			<view class="input-group">
				...
				<view class="input-row border" style="padding-top: 15rpx;">
					...
					<selectsearch  style="padding: 5px 0 0 0;" @handleSearch="handleSearch" @change="change" placeholder="请搜索医院" :infoList="infoList" :showValue="showValue"
					 v-model="searchValue" :loading="loading" type="primary" :uniShadow="true"></selectsearch>
			...
			<uni-collapse ref="add">
				<uni-collapse-item title="添加图片信息">
					<button type="primary" size="mini" class="primary" @click="chooseImage">添加图片</button>
...
<script>
	...
	export default {
		...
		onReady:function(){
				...
				var d = service.getbaotai()[this.dindex];
				...
				this.sex = d.sex;
				this.sexindex = d.sexindex;  
				this.name = d.name;
				this.doctors = d.doctors;
				this.provice = d.provice;
				this.city = d.city;
				this.hosptail = d.hosptail;
			    this.surgeryId = d.surgeryId;
				this.surgeryGrade = d.surgeryGrade;  
				this.operateDate = d.operateDate;
				this.hospitalName = d.hospitalName;
				this.searchValue = d.hospitalName;
				this.provicesname = d.provicesname;
				this.phos = d.phos;
