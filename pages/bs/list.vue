	...
	export default {
		...
		methods: {
			...
			exportData() {
				...
				let data = "?status=1&userId=" + user.id + "&beginOperateDate=" + this.beginOperateDate + "&endOperateDate=" + this
					.endOperateDate + "&hospitalName=" + this.hospitalName

				var _this = this;
				uni.downloadFile({
					url: service.exportReportStandbookOperation() + data,
